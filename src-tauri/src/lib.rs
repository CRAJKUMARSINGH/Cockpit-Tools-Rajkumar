...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::account_merge::create_named_backup,
            commands::account_merge::merge_backup_from_file,
            commands::account_merge::list_available_backups,
            commands::account_merge::read_backup_file,
            ...
            commands::system::save_named_backup,
            commands::system::merge_credentials_from_json,
